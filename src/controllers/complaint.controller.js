...
const postComplaint = asyncHandler(async (req, res) => {
    ...
    if(!sellerId || !buyerId || !orderId || !message || !messageBy){
...
const deleteComplaint = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, deleteComplaint, "Complaint deleted successfully"));

});


export {postComplaint, getAllComplaint, updateComplaintStatus, deleteComplaint}
